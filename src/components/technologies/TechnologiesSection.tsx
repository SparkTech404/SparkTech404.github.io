...
import { Sparkles, Code, Layers, Server, Database, GitBranch, Terminal } from "lucide-react";
...
export function TechnologiesSection() {
  return (
    <section id="technologies" className="relative py-20 sm:py-28 overflow-hidden">
      {/* Ambient Lighting */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
          ...
          >
            Powered by Modern <span className="text-gradient">Cutting-Edge Tech</span>
          </motion.h2>
          ...
          >
            We leverage industry-standard languages, modern frameworks, and robust cloud infrastructure to guarantee maximum stability and performance.
          </motion.p>
        </div>

        {/* 13 Glowing Bento/Grid Cards */}
          ...
          {technologies.map((tech, idx) => (
            <motion.div
              ...
              className={`glass-card p-6 flex flex-col justify-between group relative overflow-hidden bg-gradient-to-br from-slate-900/80 to-slate-950 border border-white/10 ${tech.borderGlow} transition-all duration-300 shadow-lg ${
                idx === 12 ? "sm:col-span-2 md:col-span-1 lg:col-span-1" : ""
              }`}
            >
              {/* Subtle Corner Light */}
              <div className="absolute -right-6 -top-6 w-24 h-24 rounded-full bg-white/5 blur-xl group-hover:bg-cyan-500/15 transition-all pointer-events-none" />

              <div className="flex items-center justify-between mb-4">
                <div className={`p-3 rounded-xl border ${tech.badgeColor} shadow-md group-hover:scale-110 transition-transform duration-300`}>
